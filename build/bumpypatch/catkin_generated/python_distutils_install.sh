...
echo_and_run cd "/home/rtlink/jiwon/bumpypatch_ws/src/bumpypatch"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/rtlink/jiwon/bumpypatch_ws/src/bumpypatch/setup.py" \
     \
    build --build-base "/home/rtlink/jiwon/bumpypatch_ws/build/bumpypatch" \
    install \
    --root="${DESTDIR-/}" \
